...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final historyMeds = medProvider.medicines.where((m) => m.status != 'Pending').toList();
    ...
    final sortedDates = groupedMeds.keys.toList()..sort((a, b) => b.compareTo(a));
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  _buildStatItem(context, 'Total Doses', '$totalCount', Icons.history_edu),
                  Container(height: 40, width: 1, color: Colors.grey[300]),
                  _buildStatItem(context, 'Taken', '$takenCount', Icons.check_circle_outline, color: Colors.green),
                  Container(height: 40, width: 1, color: Colors.grey[300]),
                  _buildStatItem(
                    context, 
                    'Adherence', 
                    ...
                    color: adherenceRate >= 80 ? Colors.green : (adherenceRate >= 50 ? Colors.orange : Colors.red),
                  ),
                ],
              ),
            ),
                ...
                : sortedDates.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final headerDate = DateFormat('EEEE, MMMM d, yyyy').format(parsedDate);
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              ...medsForDate.map((med) => _buildHistoryItem(context, med)),
